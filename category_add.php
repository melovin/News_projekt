...
if (isset($_POST['catName'], $_POST['des'])) {

    $c->addCategory($_POST['catName'], $_POST['des']);
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <form action="" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="catName" type="text" class="form-control" placeholder="Název" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
