...
<div class="d-flex">
    ...
    <div class="content justify-content-evenly mx-auto" style="width:80%">
        <h1 class="text-center mb-5 mt-5">Přidání autora</h1>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="d-flex">
                            <div class="input-group mb-3">
                                ...
                                <input name="autName" type="text" class="form-control" placeholder="Jméno" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group mb-3">
