                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Všechny <br> kategorie</h1>
                            <span class="subheading">Vyberte si tu, která Vás zajímá nejvíce.</span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-5">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="posts_by_category.php?id=<?= $cat['Id'] ?>" class="btn btn-primary">Více z této kategorie</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
